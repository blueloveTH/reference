...
- [Python](https://cheatsheets.zip/python.html): One-page reference sheet for the differences between [cpython](https://www.python.org/) and [pocketpy](https://github.com/blueloveTH/pocketpy).
